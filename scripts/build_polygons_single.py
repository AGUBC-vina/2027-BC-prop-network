...
def main():
    ...
    JS_OUT.write_text(
        ...
        "// 28 Thiessen polygons (single Voronoi diagram across the whole basin)\n"
        "// clipped to the Vina Subbasin (DWR B118 5-021.57). Companion to\n"
        "// js/polygons-data-three-zone.js. main.js picks one based on the\n"
        "// §5.2 'Polygon method' toggle.\n"
